...
description: "Apply when reviewing or writing browser-facing code that handles user input, renders HTML, sets cookies, or loads third-party scripts. Covers XSS, CSRF, CSP, clickjacking, XS-Leaks, and HTTP security headers."
type: knowledge-base
version: 1.0.0
...
- **CORS**: avoid `*`; allow-list origins; validate preflights; do not rely on CORS for authorization.
