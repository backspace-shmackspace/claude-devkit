...
alias generate-agent="$PYTHON_CMD $GENERATORS_DIR/generate_agents.py --type senior-architect"
...
alias gen-agent="$PYTHON_CMD $GENERATORS_DIR/generate_agents.py --type senior-architect"
...
echo "  generate-agent (gen-agent)     - Create senior-architect via generate_agents.py"
echo "  generate-agents (gen-agents)   - Create agent team (auto-detect stack)"
...
echo "  generate-agent . --tech-stack 'Next.js TypeScript'"
