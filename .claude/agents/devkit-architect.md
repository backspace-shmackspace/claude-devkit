...
6. **Structured reporting** — Consistent markdown format to `$DEVKIT_PROJECT_DIR/plans/`
...
10. **Archive on success** — Move artifacts to `$DEVKIT_PROJECT_DIR/plans/archive/`
...
Save all plans to `$DEVKIT_PROJECT_DIR/plans/[feature-name].md` (or `$PLANS_DIR/[feature-name].md`) with this structure:
...
3. You create detailed plan in `$DEVKIT_PROJECT_DIR/plans/add-mcp-agent-generator.md`
